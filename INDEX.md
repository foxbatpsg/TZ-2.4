# INDEX.md — Навигационный слой ТЗ v2.5
...
> **Обновление статуса 2026-09-16:** по решению владельца `Q-06` и `Q-07` зарегистрированы как **OPEN** в `REVIEW-REGISTRY.md` §8. Проекты: `OPEN-QUESTIONS-Q-06-Q-07.md` (не нормативный источник). Утверждённых определений нет; зависимые задачи остаются `BLOCKED`.
...
| **Q-06** | Контракт передачи контекста доказательства через MCP | — утверждённого определения в корпусе нет; проект: `OPEN-QUESTIONS-Q-06-Q-07.md`, раздел Q-06 (ненормативный) | карточки Astra1: Глава 6 стр.122; Глава 7 стр.311, 322, 338, 542 (зависимости и приёмка) | ⛔ **OPEN**; `status: open` — требуется решение владельца; зависимые задачи `BLOCKED`; `REVIEW-REGISTRY.md` §8 |
...
| **D-2** | `Q-06`/`Q-07` — открытые решения, не перенесённые в нормативный корпус | проекты: `OPEN-QUESTIONS-Q-06-Q-07.md`; регистрация: `REVIEW-REGISTRY.md` §8 | ⛔ **OPEN** — требуется утверждение владельца; зависимые карточки остаются `BLOCKED`; ложная классификация снята 2026-09-16 |
