...
> **Обновление статуса 2026-09-16:** по решению владельца `Q-06` и `Q-07` возвращены как **OPEN** в `REVIEW-REGISTRY.md` §8. Проекты: `OPEN-QUESTIONS-Q-06-Q-07.md` (не нормативный источник). Сохранившиеся ниже пометки `gap` и утверждение о закрытии их тем другими средствами ошибочны; согласование индекса, правил и валидатора перенесено в `NEXT-SESSION-PROMPT.md`. Зависимые задачи остаются `BLOCKED`.
