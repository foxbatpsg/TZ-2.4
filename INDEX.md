...
**Baseline:** `TZ-2.6 @ ba774d3` (ревизия v2.6 — перенос решения `Q-06` в нормативный корпус: вариант A, норма в `05` §4b, контракт в `MCP TOOL CONTRACTS` §3; 2026-09-16), ветка `master`.
