...
## 4. Реестр решений Q-01…Q-13 (Q-06/Q-07 — задокументированный gap)
...
| **Q-09** | Верификация авторов и статистическая выборка | `04` §16a — норма «Политика верификации авторов и статистики (Q-09)» | карточки Astra1: Глава 4, 5, 8, 10 (блокеры) | ✅ **CLOSED** (2026-09-15 — принято из черновика v1.1; база частично уже была в Q-03/профиле AGGREGATION) |
...
| **Q-12** | Целевая Windows-среда и performance acceptance | `02` §5.3 — норма «Целевая среда и performance budget (Q-12)» | карточки Astra1: Глава 8, 10, 11 (блокеры) | ✅ **CLOSED** (2026-09-15 — принято из черновика v1.1 как TARGET; численные критерии приёмки — только после benchmark-spike, S-13) |
