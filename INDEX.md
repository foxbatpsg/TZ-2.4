...
| `ARCHITECTURE.md` (производный, не нормативный) | Папка `корзина/` (включая ADR-карточки, перенесённые 2026-09-18 по решению владельца; нормативные тексты решений — `02` §3a, `03` §9b, `03` §8a) |
...
> Нормативные формулировки решений ADR-001/002/003 — `02` §3a, `03` §9b, `03` §8a; при расхождении приоритет у ТЗ. Полные тексты резолюций — реестр замечаний (архив: `корзина/`).
