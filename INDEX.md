...
| **Q-09** | Верификация авторов и статистическая выборка | `04` §16a, стр. 430 — норма «Политика верификации авторов и статистики (Q-09)» | карточки Astra1: Глава 4, 5, 8, 10 (блокеры) | ✅ **CLOSED** (2026-09-15 — принято из черновика v1.1; база частично уже была в Q-03/профиле AGGREGATION) |
...
| **Q-11** | Перенос Study / откат snapshot | `06` §13, стр. 259 — норма «Перенос Study и откат (Q-11)» | карточки Astra1: Глава 2, 8 (блокеры) | ✅ **CLOSED** (2026-09-15 — принято из черновика v1.1) |
...
| **Q-13** | Administrator diagnostic token | `EPIC SPECIFICATIONS v1.0` §12, стр. 242 — определение «Административный диагностический доступ (Q-13)» | `02` §7 стр.301; `MASTER ROADMAP v1.2` §14 стр.448; `EPIC→TASK` §13 стр.568 | ✅ **CLOSED** (2026-09-13) — **не вводится в MVP** |
...
| MCP Tool Contracts | `MCP TOOL CONTRACTS v1.1.md` | 23 инструмента, полные контракты; §3 `search_within_document` — опция `include_evidence_context`, 32 KiB (Q-06, 2026-09-16); §4/§5 — `local_analysis` `task_id` (Q-07, 2026-09-16) |
