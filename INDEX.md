...
| **A-24** | Хранимый BM25-индекс: SQLite FTS5, персистентный в Project DB; пересборка при каждом запуске недопустима | `04` §14, стр. 256 | `02` §5.1 стр.133 | — |
...
| BM25 и RU-морфология | `04` §14/14.1 | — | **A-13 (D-1)**; A-24 |
