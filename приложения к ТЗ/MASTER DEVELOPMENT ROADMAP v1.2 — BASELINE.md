...
Утверждённое ТЗ v2.7 и нормативные приложения имеют приоритет над Roadmap и TASK.
...
1. утверждённое ТЗ v2.7 + утверждённые изменения (УИ v1.0: A-01…A-21, Q-01…Q-05);
