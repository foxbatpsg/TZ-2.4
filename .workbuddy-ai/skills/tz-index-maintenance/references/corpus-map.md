# Карта нормативного корпуса ТЗ v2.5

**Область индексации:** 7 разделов основного ТЗ + 7 приложений + `ARCHITECTURE.md` (производный).
**Baseline:** `TZ-2.5 @ 32e115f` (ревизия v2.5 — после закрытия `ADR-001/002/003`, `D-4`, `D-6`, `Q-09`…`Q-12` и находок аудита `F-01`/`F-04`; 2026-09-16), ветка `master`.

## Иерархия приоритета документов

```
ТЗ v2.5 (разделы 01–07)
  ↓
